...
local function logic()
    ...
    local function apply_hack(hack, system, weapon)
        if system then
            ...
            if not sysHackData.immuneTime or sysHackData.immuneTime <= 0 then
                ...
                -- I realise I should have made a function for this
    ...
    -- Find the weapon that was recently fired
    ...
    script.on_internal_event(Defines.InternalEvents.DAMAGE_AREA_HIT, function(shipManager, projectile, location, damage, shipFriendlyFire)
        ...
        if hack and hack.duration and hack.duration > 0 then
            ...
            if shipManager.iShipId == Hyperspace.ships.player.iShipId then
                opponent = Hyperspace.ships.enemy
            end
